/**
 * Express Server para OCR Landing Page
 * Deploy: Railway
 * Porta: 3000
 */
...
// Keywords para detectar cobranças
...
async function sendClientEmail(clientData, detectedCharges) {
  ...
  const mailOptions = {
    ...
    html: `
      ...
      ${chargesHtml}
      <p><strong>⚠️ Aviso Legal:</strong> Esta é uma análise inicial automatizada. Nossa equipe jurídica entrará em contato em breve para discussão detalhada.</p>
...
/**
 * Rota principal - serve landing.html
 */
app.get('/', (req, res) => {
 ...
 */
app.listen(PORT, () => {
  console.log(`🚀 OCR Landing Page running on port ${PORT}`);
